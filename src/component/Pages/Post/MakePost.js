...
import imgIcon from '../../image/uploadIcon/image.jpg';
import videoIcon from '../../image/uploadIcon/video.png';
...
const MakePost = () => {
  ...
  const handlePostSubmit = async () => {
    try {
      ...
      const response = await axios.post('http://localhost:3001/api/post', data, {
        headers: {
          ...
          {showShareOptions && selectedOption && (
            <div className="mt-4 grid grid-cols-4 gap-4">
              ...
              <div onClick={handleImageClick} className="col-span-1">
                <img src={imgIcon} alt="" className='h-10 w-10 rounded-3xl' />
              ...
              <div onClick={handleVideoClick} className="col-span-1">
                <img src={videoIcon} alt="" className='h-10 w-10 rounded-3xl' />
